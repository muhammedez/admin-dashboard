...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-white px-6 dark:border-gray-800 dark:bg-gray-900">
      <button onClick={toggleSidebar} className="rounded-lg p-2 hover:bg-gray-50 dark:hover:bg-gray-800 lg:hidden" title="Toggle sidebar">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="w-full rounded-sm border bg-gray-50 py-2 pl-10 pr-4 text-sm outline-none focus:border-indigo-500 focus:bg-white dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500 dark:focus:bg-gray-800"
        />
      </div>
      ...
      <button className="relative rounded-lg p-2 hover:bg-gray-50 dark:hover:bg-gray-800">
      ...
      <button
        ...
        disabled={loggingOut}
        className="rounded-lg p-2 text-gray-400 hover:bg-gray-50 hover:text-red-600 dark:hover:bg-gray-800 dark:hover:text-red-400"
        title="Log out"
      >
